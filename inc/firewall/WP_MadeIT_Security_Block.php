...
class WP_MadeIT_Security_Block
{
    ...
    public function createBlock($ipaddress, $timeToBlock, $reasonNr)
    {
        ...
        $this->db->queryWrite(
            'INSERT INTO '.$this->db->prefix().'madeit_sec_blockip (ipaddress, country, start_block, end_block, blocked, reasonNr, reason, notify, created_at) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)',
            $ipaddress,
            '',
            time(),
            time() + $timeToBlock,
