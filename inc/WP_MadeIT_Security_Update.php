...
class WP_MadeIT_Security_Update {
    ...
    private function postInfoToMadeIT($key, $info) {
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query(array('info' => json_encode($info))));
    ...
    public function addHooks() {
        add_action('madeit_security_check_plugin_updates', array($this, 'check_plugin_updates'));
        add_action('upgrader_process_complete', array($this, 'check_plugin_updates'));
