                                ...
                                <?php foreach([
                                    ...
                                    <div class="madeit-col-3">
                                        <div class="madeit-row">
                                            ...
                                            <div class="madeit-col">
                                                <?php if($status == "OK") { ?> <i class="fa fa-check madeit-text-success"></i> <?php } else { ?> <i class="fa fa-times madeit-text-danger"></i> <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                                        ...
                                        <div class="madeit-row">
                                            ...
                                            <div class="madeit-col madeit-text-center">
                                                ...
                                                <div id="backup-result">
                                                    ...
                                                    <?php if($backupExecutionData['preCheck']) { ?><i class="fa fa-check madeit-text-success"></i><?php } else { echo $backupExecutionData['check_error']; } ?>
                                                    <br>
